...
public class BenchmarksPropsValues {
	...
	public static final int MAX_CT_CONTENT_LAYOUT_COUNT = GetterUtil.getInteger(
		PropertiesHolder._get(BenchmarksPropsKeys.MAX_CT_CONTENT_LAYOUT_COUNT));
	...
	public static final int MAX_CT_JOURNAL_ARTICLE_PAGE_COUNT =
		GetterUtil.getInteger(
			PropertiesHolder._get(
				BenchmarksPropsKeys.MAX_CT_JOURNAL_ARTICLE_PAGE_COUNT));

	public static final int MAX_CT_JOURNAL_ARTICLE_VERSION_COUNT =
		GetterUtil.getInteger(
			PropertiesHolder._get(
				BenchmarksPropsKeys.MAX_CT_JOURNAL_ARTICLE_VERSION_COUNT));
