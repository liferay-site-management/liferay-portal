...
public class SocialActivityCounterTableReferenceDefinitionTest
	...
	protected CTModel<?> addCTModel() throws Exception {
		return _socialActivityCounterLocalService.addActivityCounter(
			group.getGroupId(), group.getClassNameId(), group.getClassPK(),
			RandomTestUtil.randomString(), 0, 0, 0, 0);
	}

	@Inject
	private static SocialActivityCounterLocalService
