...
public class SiteResourceImpl extends BaseSiteResourceImpl {
	...
	private String _getTypeSettings(
		...
		if (oldUnicodeProperties.containsKey("defaultSiteRoleIds")) {
			unicodeProperties.put(
				"defaultSiteRoleIds",
				oldUnicodeProperties.get("defaultSiteRoleIds"));
		}

		if (oldUnicodeProperties.containsKey("defaultTeamIds")) {
			unicodeProperties.put(
				"defaultTeamIds", oldUnicodeProperties.get("defaultTeamIds"));
		}
	...
	private static final String[] _EXCLUDED_TYPE_SETTINGS = {
		"defaultSiteRoleIds", "defaultTeamIds",
		GooglePlacesWebKeys.GOOGLE_PLACES_API_KEY, "googleMapsAPIKey"
	};
