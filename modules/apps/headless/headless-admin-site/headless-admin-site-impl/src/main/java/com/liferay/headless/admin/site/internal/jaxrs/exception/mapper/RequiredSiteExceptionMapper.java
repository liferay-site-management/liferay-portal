...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Admin.Site.RequiredSiteExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class RequiredSiteExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			mustNotDeactivateSystemGroup.getMessage());
	}
