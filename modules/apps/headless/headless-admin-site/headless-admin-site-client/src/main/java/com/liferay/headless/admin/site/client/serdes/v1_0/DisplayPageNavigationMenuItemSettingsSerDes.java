...
public class DisplayPageNavigationMenuItemSettingsSerDes {
	...
	public static String toJSON(
		...
		if (displayPageNavigationMenuItemSettings.getLocalizedNames() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				_toJSON(
					displayPageNavigationMenuItemSettings.getLocalizedNames()));
		}
	...
	public static class DisplayPageNavigationMenuItemSettingsJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "className")) {
				...
				if (jsonParserFieldValue != null) {
					displayPageNavigationMenuItemSettings.setLocalizedNames(
