...
public class PageNavigationMenuItemSettingsSerDes {
	...
	public static String toJSON(
		...
		if (pageNavigationMenuItemSettings.getLocalizedNames() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				_toJSON(pageNavigationMenuItemSettings.getLocalizedNames()));
		}
		...
		if (pageNavigationMenuItemSettings.getScopeExternalReferenceCode() !=
				null) {
	...
	public static Map<String, String> toMap(
		...
		if (pageNavigationMenuItemSettings.getLocalizedNames() == null) {
			...
			map.put(
				"localizedNames",
				String.valueOf(
					pageNavigationMenuItemSettings.getLocalizedNames()));
		}
	...
	public static class PageNavigationMenuItemSettingsJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			...
			else if (Objects.equals(jsonParserFieldName, "localizedNames")) {
				return true;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "externalReferenceCode")) {
				...
				if (jsonParserFieldValue != null) {
					pageNavigationMenuItemSettings.setLocalizedNames(
