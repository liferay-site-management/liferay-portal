...
import com.liferay.launch.web.internal.constants.LaunchConstants;
...
public class LaunchPanelApp extends BasePanelApp {
	...
	public String getPortletId() {
		return LaunchConstants.PORTLET_ID;
	}
	...
	@Reference(
		target = "(jakarta.portlet.name=" + LaunchConstants.PORTLET_ID + ")"
	)
