...
package com.liferay.launch.rest.dto.v1_0;
 ...
 */
@Generated("")
@GraphQLName("LaunchEntry")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "LaunchEntry")
public class LaunchEntry implements Serializable {

	public static LaunchEntry toDTO(String json) {
		return ObjectMapperUtil.readValue(LaunchEntry.class, json);
	}

	public static LaunchEntry unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(LaunchEntry.class, json);
	}
	...
	public Long getLaunchSetId() {
		if (_launchSetIdSupplier != null) {
			launchSetId = _launchSetIdSupplier.get();

			_launchSetIdSupplier = null;
		}
	...
	public void setLaunchSetId(
		...
		_launchSetIdSupplier = () -> {
			try {
				return launchSetIdUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<Long> _launchSetIdSupplier;
	...
	public String toString() {
		...
		Long launchSetId = getLaunchSetId();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.launch.rest.dto.v1_0.LaunchEntry",
		name = "x-class-name"
	)
