...
/**
 * Provides the local service interface for AssetTagDepotEntryRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AssetTagDepotEntryRelLocalServiceUtil
 * @generated
 */
@CTAware
@ProviderType
...
public interface AssetTagDepotEntryRelLocalService
	extends BaseLocalService, CTService<AssetTagDepotEntryRel>,
			PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.asset.tags.service.impl.AssetTagDepotEntryRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the asset tag depot entry rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AssetTagDepotEntryRelLocalServiceUtil} if injection and service tracking are not available.
	 */
