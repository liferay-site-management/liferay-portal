...
/**
 * Provides the remote service interface for AssetTagDepotEntryRel. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see AssetTagDepotEntryRelServiceUtil
 * @generated
 */
@AccessControlled
@CTAware
...
public interface AssetTagDepotEntryRelService extends BaseService {
