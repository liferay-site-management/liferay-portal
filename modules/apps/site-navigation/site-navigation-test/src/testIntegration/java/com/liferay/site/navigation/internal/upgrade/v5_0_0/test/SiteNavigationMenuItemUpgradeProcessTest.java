...
public class SiteNavigationMenuItemUpgradeProcessTest {
		...
		SiteNavigationMenuItem siteNavigationMenuItem =
			_addSiteNavigationMenuItem(
				...
				UnicodePropertiesBuilder.create(
					...
					"externalReferenceCode", blogsEntry.getEntryId()
				).buildString());

		_runUpgrade();

		_assert(siteNavigationMenuItem.getSiteNavigationMenuItemId());
	}
	...
	public void testUpgradeWithNode() throws Exception {
		...
		_assertNull(siteNavigationMenuItem.getSiteNavigationMenuItemId());
	}
	...
	public void testUpgradeWithSiteScopedObjectEntry() throws Exception {
		...
		ObjectEntry objectEntry = ObjectEntryTestUtil.addObjectEntry(
			_group.getGroupId(), siteScopedObjectDefinition,
	...
	private void _assert(long siteNavigationMenuItemId) throws Exception {
		SiteNavigationMenuItem siteNavigationMenuItem =
			_siteNavigationMenuItemLocalService.getSiteNavigationMenuItem(
	...
	private void _assertNull(long siteNavigationMenuItemId) throws Exception {
		SiteNavigationMenuItem siteNavigationMenuItem =
			_siteNavigationMenuItemLocalService.getSiteNavigationMenuItem(
				siteNavigationMenuItemId);
