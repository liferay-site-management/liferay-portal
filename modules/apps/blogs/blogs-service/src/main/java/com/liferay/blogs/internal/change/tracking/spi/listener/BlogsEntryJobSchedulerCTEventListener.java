...
package com.liferay.blogs.internal.change.tracking.spi.listener;
...
public class BlogsEntryJobSchedulerCTEventListener implements CTEventListener {

	@Override
	public void onAfterPublish(long ctCollectionId) throws CTEventException {
		try {
			String name =
				"com.liferay.blogs.web.internal.scheduler." +
					"CheckEntrySchedulerJobConfiguration";
