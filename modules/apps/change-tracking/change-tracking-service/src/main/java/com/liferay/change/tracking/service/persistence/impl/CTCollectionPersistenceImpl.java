...
public class CTCollectionPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByC_SV;
	private FinderPath _finderPathWithoutPaginationFindByC_SV;
	private FinderPath _finderPathCountByC_SV;
	 ...
	 */
	@Override
	public List<CTCollection> findByC_SV(long companyId, long schemaVersionId) {
		return findByC_SV(
	 ...
	 */
	@Override
	public List<CTCollection> findByC_SV(
		long companyId, long schemaVersionId, int start, int end) {

		return findByC_SV(companyId, schemaVersionId, start, end, null);
	}
	...
	public List<CTCollection> findByC_SV(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByC_SV;
				finderArgs = new Object[] {companyId, schemaVersionId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByC_SV;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_C_SV_COMPANYID_2);

			sb.append(_FINDER_COLUMN_C_SV_SCHEMAVERSIONID_2);
	 ...
	 */
	@Override
	public CTCollection findByC_SV_First(
			long companyId, long schemaVersionId,
			OrderByComparator<CTCollection> orderByComparator)
		throws NoSuchCollectionException {

		CTCollection ctCollection = fetchByC_SV_First(
	 ...
	 */
	@Override
	public CTCollection fetchByC_SV_First(
		long companyId, long schemaVersionId,
		OrderByComparator<CTCollection> orderByComparator) {

		List<CTCollection> list = findByC_SV(
	 ...
	 */
	@Override
	public CTCollection findByC_SV_Last(
			long companyId, long schemaVersionId,
			OrderByComparator<CTCollection> orderByComparator)
		throws NoSuchCollectionException {

		CTCollection ctCollection = fetchByC_SV_Last(
			companyId, schemaVersionId, orderByComparator);
	 ...
	 */
	@Override
	public CTCollection fetchByC_SV_Last(
		long companyId, long schemaVersionId,
		OrderByComparator<CTCollection> orderByComparator) {

		int count = countByC_SV(companyId, schemaVersionId);
	 ...
	 */
	@Override
	public CTCollection[] findByC_SV_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_SV_PrevAndNext(
				session, ctCollection, companyId, schemaVersionId,
				orderByComparator, true);

			array[1] = ctCollection;

			array[2] = getByC_SV_PrevAndNext(
				session, ctCollection, companyId, schemaVersionId,
	...
	protected CTCollection getByC_SV_PrevAndNext(
		Session session, CTCollection ctCollection, long companyId,
	 ...
	 */
	@Override
	public List<CTCollection> filterFindByC_SV(
		long companyId, long schemaVersionId) {

		return filterFindByC_SV(
			companyId, schemaVersionId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	...
	public List<CTCollection> filterFindByC_SV(
		...
		return filterFindByC_SV(companyId, schemaVersionId, start, end, null);
	}
	 ...
	 */
	@Override
	public CTCollection[] filterFindByC_SV_PrevAndNext(
			long ctCollectionId, long companyId, long schemaVersionId,
			OrderByComparator<CTCollection> orderByComparator)
		throws NoSuchCollectionException {

		if (!InlineSQLHelperUtil.isEnabled(companyId, 0)) {
			return findByC_SV_PrevAndNext(
		...
		try {
			...
			array[0] = filterGetByC_SV_PrevAndNext(
				session, ctCollection, companyId, schemaVersionId,
				orderByComparator, true);

			array[1] = ctCollection;

			array[2] = filterGetByC_SV_PrevAndNext(
				session, ctCollection, companyId, schemaVersionId,
				orderByComparator, false);
	...
	protected CTCollection filterGetByC_SV_PrevAndNext(
		Session session, CTCollection ctCollection, long companyId,
		long schemaVersionId, OrderByComparator<CTCollection> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public void removeByC_SV(long companyId, long schemaVersionId) {
		for (CTCollection ctCollection :
				findByC_SV(
	 ...
	 */
	@Override
	public int countByC_SV(long companyId, long schemaVersionId) {
		FinderPath finderPath = _finderPathCountByC_SV;
	 ...
	 */
	@Override
	public int filterCountByC_SV(long companyId, long schemaVersionId) {
		if (!InlineSQLHelperUtil.isEnabled(companyId, 0)) {
			return countByC_SV(companyId, schemaVersionId);
		}
	...
	private static final String _FINDER_COLUMN_C_SV_COMPANYID_2 =
		"ctCollection.companyId = ? AND ";

	private static final String _FINDER_COLUMN_C_SV_SCHEMAVERSIONID_2 =
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByC_SV = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_SV",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByC_SV = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_SV",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"companyId", "schemaVersionId"}, true);

		_finderPathCountByC_SV = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_SV",
			new String[] {Long.class.getName(), Long.class.getName()},
