...
import com.liferay.change.tracking.internal.upgrade.v2_16_0.CTCollectionScoreSizeClassificationUpgradeProcess;
...
public class ChangeTrackingServiceUpgradeStepRegistrator
	...
	public void register(Registry registry) {
		...
		registry.register(
			"2.15.0", "2.16.0",
			new CTCollectionScoreSizeClassificationUpgradeProcess());
	}
