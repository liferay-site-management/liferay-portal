 ...
 */
@Component(
	property = "destination.name=" + CTDestinationNames.CT_ENTRY_INDEXER,
	service = MessageListener.class
)
public class CTEntryIndexerMessageListener extends BaseMessageListener {
	...
	protected void activate(BundleContext bundleContext) {
		DestinationConfiguration destinationConfiguration =
			new DestinationConfiguration(
				...
				CTDestinationNames.CT_ENTRY_INDEXER);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CTEntryIndexerMessageListener.class);
