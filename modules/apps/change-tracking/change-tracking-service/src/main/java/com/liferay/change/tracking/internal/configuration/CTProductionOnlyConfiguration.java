...
@Meta.OCD(
	id = "com.liferay.change.tracking.internal.configuration.CTProductionOnlyConfiguration",
	localization = "content/Language",
	name = "publications-production-only-models-configuration-name"
)
public interface CTProductionOnlyConfiguration {

	@Meta.AD(
		deflt = "", description = "production-only-class-names-help",
