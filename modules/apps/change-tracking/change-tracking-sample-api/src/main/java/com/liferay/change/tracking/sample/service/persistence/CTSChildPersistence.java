...
public interface CTSChildPersistence
	 ...
	 * @throws NoSuchChildException if a matching cts child could not be found
	 */
	 ...
	 * @throws NoSuchChildException if a cts child with the primary key could not be found
	 */
	 ...
	 * @throws NoSuchChildException if a cts child with the primary key could not be found
	 */
	public CTSChild remove(long ctsChildId) throws NoSuchChildException;

	public CTSChild updateImpl(CTSChild ctsChild);

	/**
	 * Returns the cts child with the primary key or throws a <code>NoSuchChildException</code> if it could not be found.
	 *
	 * @param ctsChildId the primary key of the cts child
