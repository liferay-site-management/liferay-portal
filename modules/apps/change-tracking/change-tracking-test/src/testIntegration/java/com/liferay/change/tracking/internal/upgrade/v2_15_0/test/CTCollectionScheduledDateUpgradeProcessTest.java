...
public class CTCollectionScheduledDateUpgradeProcessTest {
	...
	public void testUpgrade() throws Exception {
		CTCollection missingScheduleJobCTCollection = _addCTCollection(true);
		...
		missingScheduleJobCTCollection =
			_ctCollectionLocalService.getCTCollection(
				missingScheduleJobCTCollection.getCtCollectionId());

		Assert.assertNull(missingScheduleJobCTCollection.getScheduledDate());
		Assert.assertEquals(
			WorkflowConstants.STATUS_DRAFT,
			missingScheduleJobCTCollection.getStatus());
		...
		Assert.assertEquals(
			...
			scheduledCTCollection.getStatus());
	...
	private void _scheduleJob(CTCollection ctCollection, Date date)
		...
		message.put("ctCollectionId", ctCollection.getCtCollectionId());
