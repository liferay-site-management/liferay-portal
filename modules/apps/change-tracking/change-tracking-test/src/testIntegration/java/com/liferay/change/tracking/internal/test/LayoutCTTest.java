...
public class LayoutCTTest {
	...
	@Test
	public void testDeleteLayoutWithModifiedLayoutInPublication()
		throws Exception {
	...
	@Test
	public void testPublishDeletedLayoutWithModificationInAnotherPublication()
		throws Exception {
		...
		boolean hasModificationDeletionConflict = false;
		...
		for (ConflictInfo conflictInfo : conflictInfos) {
			if ((conflictInfo.getSourcePrimaryKey() == layout.getPlid()) &&
				...
				hasModificationDeletionConflict = true;
			}
		}
		...
		Assert.assertTrue(
			...
			hasModificationDeletionConflict);
	}
