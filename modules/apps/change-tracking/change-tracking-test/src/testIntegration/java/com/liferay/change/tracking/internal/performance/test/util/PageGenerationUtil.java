...
package com.liferay.change.tracking.internal.performance.test.util;
...
import com.liferay.portal.tools.sample.sql.builder.BenchmarksPropsKeys;
...
public class PageGenerationUtil {
	...
	public static void createPageTestData(int count) throws Exception {
		...
		_setBenchmarkProperty(
			BenchmarksPropsKeys.MAX_CONTENT_LAYOUT_COUNT, String.valueOf(count),
			properties);
	...
	private static void _initProperties(Properties properties) {
		properties.put(
		...
		properties.put(
			...
			"com/liferay/change/tracking/dependencies/layout.ftl");
		properties.put(BenchmarksPropsKeys.SEARCH_BAR_ENABLED, "true");
		properties.put(BenchmarksPropsKeys.VIRTUAL_HOST_NAME, "localhost");
	}

	private static void _loadHypersonic(Connection connection, String fileName)
		throws Exception {
	...
	private static void _loadHypersonic(String outputDir) throws Exception {
	...
	private static void _setBenchmarkProperty(
		String benchmarkPropsKey, String benchmarkPropsValue,
		Properties properties) {

		properties.put(benchmarkPropsKey, benchmarkPropsValue);
	}
