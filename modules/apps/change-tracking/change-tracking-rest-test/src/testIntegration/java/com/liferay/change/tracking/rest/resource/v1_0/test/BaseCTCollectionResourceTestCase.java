...
public abstract class BaseCTCollectionResourceTestCase {
	...
	@Test
	public void testPutCTCollectionByExternalReferenceCode() throws Exception {
		CTCollection postCTCollection =
			testPutCTCollectionByExternalReferenceCode_addCTCollection();

		CTCollection randomCTCollection = randomCTCollection();

		CTCollection putCTCollection =
			ctCollectionResource.putCTCollectionByExternalReferenceCode(
				postCTCollection.getExternalReferenceCode(),
				randomCTCollection);
		...
		CTCollection getCTCollection =
			ctCollectionResource.getCTCollectionByExternalReferenceCode(
				putCTCollection.getExternalReferenceCode());

		assertEquals(randomCTCollection, getCTCollection);
		assertValid(getCTCollection);

		CTCollection newCTCollection =
			testPutCTCollectionByExternalReferenceCode_createCTCollection();

		putCTCollection =
			ctCollectionResource.putCTCollectionByExternalReferenceCode(
				newCTCollection.getExternalReferenceCode(), newCTCollection);

		assertEquals(newCTCollection, putCTCollection);
		assertValid(putCTCollection);
		...
		assertEquals(newCTCollection, getCTCollection);
