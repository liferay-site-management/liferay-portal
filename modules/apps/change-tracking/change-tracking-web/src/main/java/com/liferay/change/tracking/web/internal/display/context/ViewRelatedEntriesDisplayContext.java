...
public class ViewRelatedEntriesDisplayContext {
	...
	public ViewRelatedEntriesDisplayContext(
		...
		_ctEntryIds = ListUtil.fromArray(
			StringUtil.split(
		...
		_filterConflictedEntries = mvcRenderCommand.equals(
	...
	private final List<Long> _ctEntryIds;
	private final CTEntryLocalService _ctEntryLocalService;
	private final boolean _filterConflictedEntries;
