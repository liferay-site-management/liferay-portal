 ...
 * @author David Truong
 */
@Component(immediate = true, service = CTSettingsConfigurationListener.class)
public class PublicationsCTSettingsConfigurationListener
	implements CTSettingsConfigurationListener {
