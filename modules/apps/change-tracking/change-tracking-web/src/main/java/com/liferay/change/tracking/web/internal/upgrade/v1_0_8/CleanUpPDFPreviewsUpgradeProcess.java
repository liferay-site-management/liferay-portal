	...
	private void _cleanUpCTSContent() throws Exception {
		...
		try (PreparedStatement preparedStatement = connection.prepareStatement(
				StringBundler.concat(
					...
					"CTEntry where CTEntry.modelClassNameId = ",
					ctsContentClassNameId, " inner join CTSContent on ",
					"(CTSContent.ctsContentId = CTEntry.modelClassPK and (",
	...
	private void _cleanUpDLFileVersionPreviews() throws Exception {
		...
		try (PreparedStatement preparedStatement = connection.prepareStatement(
				StringBundler.concat(
					...
					"CTEntry.modelClassNameId, CTEntry.modelClassPK from ",
					"CTEntry where CTEntry.modelClassNameId = ",
					dlFileVersionPreviewClassNameId, "inner join ",
					"DLFileVersionPreview on ",
					"DLFileVersionPreview.dlFileVersionPreviewId = ",
