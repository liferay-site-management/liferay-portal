...
public class CTCollectionUtil {
	 ...
	 * @return the matching ct collections
	 */
	public static List<CTCollection> findByC_SV(
		long companyId, long schemaVersionId) {

		return getPersistence().findByC_SV(companyId, schemaVersionId);
	}
	...
	public static List<CTCollection> findByC_SV(
		...
		return getPersistence().findByC_SV(
	 ...
	 * @throws NoSuchCollectionException if a matching ct collection could not be found
	 */
	public static CTCollection findByC_SV_First(
			long companyId, long schemaVersionId,
			OrderByComparator<CTCollection> orderByComparator)
		throws com.liferay.change.tracking.exception.NoSuchCollectionException {

		return getPersistence().findByC_SV_First(
	 ...
	 * @return the first matching ct collection, or <code>null</code> if a matching ct collection could not be found
	 */
	public static CTCollection fetchByC_SV_First(
		long companyId, long schemaVersionId,
		OrderByComparator<CTCollection> orderByComparator) {

		return getPersistence().fetchByC_SV_First(
			companyId, schemaVersionId, orderByComparator);
	}
	 ...
	 * @throws NoSuchCollectionException if a matching ct collection could not be found
	 */
	public static CTCollection findByC_SV_Last(
			long companyId, long schemaVersionId,
			OrderByComparator<CTCollection> orderByComparator)
		throws com.liferay.change.tracking.exception.NoSuchCollectionException {

		return getPersistence().findByC_SV_Last(
			companyId, schemaVersionId, orderByComparator);
	}
	 ...
	 * @return the last matching ct collection, or <code>null</code> if a matching ct collection could not be found
	 */
	public static CTCollection fetchByC_SV_Last(
		long companyId, long schemaVersionId,
		OrderByComparator<CTCollection> orderByComparator) {

		return getPersistence().fetchByC_SV_Last(
			companyId, schemaVersionId, orderByComparator);
	}
	 ...
	 * @throws NoSuchCollectionException if a ct collection with the primary key could not be found
	 */
	public static CTCollection[] findByC_SV_PrevAndNext(
			long ctCollectionId, long companyId, long schemaVersionId,
			OrderByComparator<CTCollection> orderByComparator)
		throws com.liferay.change.tracking.exception.NoSuchCollectionException {

		return getPersistence().findByC_SV_PrevAndNext(
	 ...
	 * @return the matching ct collections that the user has permission to view
	 */
	public static List<CTCollection> filterFindByC_SV(
		long companyId, long schemaVersionId) {

		return getPersistence().filterFindByC_SV(companyId, schemaVersionId);
	}
	...
	public static List<CTCollection> filterFindByC_SV(
		...
		return getPersistence().filterFindByC_SV(
			companyId, schemaVersionId, start, end);
	}
	 ...
	 * @throws NoSuchCollectionException if a ct collection with the primary key could not be found
	 */
	public static CTCollection[] filterFindByC_SV_PrevAndNext(
			long ctCollectionId, long companyId, long schemaVersionId,
			OrderByComparator<CTCollection> orderByComparator)
		throws com.liferay.change.tracking.exception.NoSuchCollectionException {

		return getPersistence().filterFindByC_SV_PrevAndNext(
			ctCollectionId, companyId, schemaVersionId, orderByComparator);
	}
	 ...
	 * @param schemaVersionId the schema version ID
	 */
	public static void removeByC_SV(long companyId, long schemaVersionId) {
		getPersistence().removeByC_SV(companyId, schemaVersionId);
	}
	 ...
	 * @return the number of matching ct collections
	 */
	public static int countByC_SV(long companyId, long schemaVersionId) {
		return getPersistence().countByC_SV(companyId, schemaVersionId);
	}
	 ...
	 * @return the number of matching ct collections that the user has permission to view
	 */
	public static int filterCountByC_SV(long companyId, long schemaVersionId) {
		return getPersistence().filterCountByC_SV(companyId, schemaVersionId);
	}
