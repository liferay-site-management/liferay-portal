...
/**
 * The table class for the &quot;Parent&quot; database table.
 *
 * @author Brian Wing Shun Chan
 * @see Parent
 * @generated
 */
public class ParentTable extends BaseTable<ParentTable> {

	public static final ParentTable INSTANCE = new ParentTable();

	public final Column<ParentTable, Long> mvccVersion = createColumn(
	...
	public final Column<ParentTable, Long> companyId = createColumn(
