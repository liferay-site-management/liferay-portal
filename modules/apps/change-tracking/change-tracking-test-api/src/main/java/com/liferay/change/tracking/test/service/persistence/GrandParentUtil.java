...
/**
 * The persistence utility for the grand parent service. This utility wraps <code>com.liferay.change.tracking.test.service.persistence.impl.GrandParentPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class GrandParentUtil {
	...
	public static GrandParent findByCompanyId_First(
		...
		throws com.liferay.change.tracking.test.exception.
