...
public interface ParentLocalService
	extends BaseLocalService, CTService<Parent>, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.change.tracking.test.service.impl.ParentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the parent local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ParentLocalServiceUtil} if injection and service tracking are not available.
	 */
