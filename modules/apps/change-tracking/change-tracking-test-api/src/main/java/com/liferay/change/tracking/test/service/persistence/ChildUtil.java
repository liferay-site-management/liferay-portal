...
package com.liferay.change.tracking.test.service.persistence;
...
public class ChildUtil {
	...
	public static Child findByCompanyId_First(
		...
		throws com.liferay.change.tracking.test.exception.NoSuchChildException {
