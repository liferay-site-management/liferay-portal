...
/**
 * Provides the local service interface for GrandParent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GrandParentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GrandParentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.change.tracking.test.service.impl.GrandParentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the grand parent local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link GrandParentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public GrandParent addGrandParent(GrandParent grandParent);

	public GrandParent addGrandParent(long companyId);

	public GrandParent addGrandParent(long companyId, long parentGrandParentId);
	...
	public GrandParent createGrandParent(long grandParentId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public GrandParent deleteGrandParent(long grandParentId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GrandParent fetchGrandParent(long grandParentId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GrandParent getGrandParent(long grandParentId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GrandParent> getGrandParents(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public GrandParent updateGrandParent(GrandParent grandParent);
