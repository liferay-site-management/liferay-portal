...
public class CTSContentUtil {
	 ...
	 */
	public static List<CTSContent> findByR_LikeP(
		long repositoryId, String path) {

		return getPersistence().findByR_LikeP(repositoryId, path);
	}
	...
	public static List<CTSContent> findByR_LikeP(
		...
		return getPersistence().findByR_LikeP(repositoryId, path, start, end);
	}
	...
	public static List<CTSContent> findByR_LikeP(
		...
		return getPersistence().findByR_LikeP(
	 ...
	 */
	public static CTSContent findByR_LikeP_First(
			long repositoryId, String path,
			OrderByComparator<CTSContent> orderByComparator)
		throws com.liferay.change.tracking.store.exception.
			NoSuchContentException {

		return getPersistence().findByR_LikeP_First(
	 ...
	 */
	public static CTSContent fetchByR_LikeP_First(
		long repositoryId, String path,
		OrderByComparator<CTSContent> orderByComparator) {

		return getPersistence().fetchByR_LikeP_First(
			repositoryId, path, orderByComparator);
	}
	 ...
	 * @throws NoSuchContentException if a matching cts content could not be found
	 */
	public static CTSContent findByR_LikeP_Last(
			long repositoryId, String path,
			OrderByComparator<CTSContent> orderByComparator)
		throws com.liferay.change.tracking.store.exception.
			NoSuchContentException {

		return getPersistence().findByR_LikeP_Last(
			repositoryId, path, orderByComparator);
	}
	 ...
	 */
	public static CTSContent fetchByR_LikeP_Last(
		long repositoryId, String path,
		OrderByComparator<CTSContent> orderByComparator) {

		return getPersistence().fetchByR_LikeP_Last(
			repositoryId, path, orderByComparator);
	}
	 ...
	 */
	public static CTSContent[] findByR_LikeP_PrevAndNext(
			long ctsContentId, long repositoryId, String path,
			OrderByComparator<CTSContent> orderByComparator)
		throws com.liferay.change.tracking.store.exception.
			NoSuchContentException {

		return getPersistence().findByR_LikeP_PrevAndNext(
	 ...
	 * @param path the path
	 */
	public static void removeByR_LikeP(long repositoryId, String path) {
		getPersistence().removeByR_LikeP(repositoryId, path);
	}
	 ...
	 */
	public static int countByR_LikeP(long repositoryId, String path) {
		return getPersistence().countByR_LikeP(repositoryId, path);
	}
