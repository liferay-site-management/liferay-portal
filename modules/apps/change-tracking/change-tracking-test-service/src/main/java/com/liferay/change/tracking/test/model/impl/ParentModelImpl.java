...
import com.liferay.change.tracking.test.model.ParentModel;
...
/**
 * The base model implementation for the Parent service. Represents a row in the &quot;Parent&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ParentModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"parentId", Types.BIGINT}, {"companyId", Types.BIGINT},
	...
	public static final String TABLE_SQL_CREATE =
		"create table Parent (mvccVersion LONG default 0 not null,ctCollectionId LONG default 0 not null,parentId LONG not null,companyId LONG,name VARCHAR(75) null,grandParentId LONG,primary key (parentId, ctCollectionId))";

	public static final String TABLE_SQL_DROP = "drop table Parent";

	public static final String ORDER_BY_JPQL = " ORDER BY parent.parentId ASC";

	public static final String ORDER_BY_SQL = " ORDER BY Parent.parentId ASC";
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("mvccVersion", Parent::getMvccVersion);
			attributeGetterFunctions.put(
				"ctCollectionId", Parent::getCtCollectionId);
			attributeGetterFunctions.put("parentId", Parent::getParentId);
			attributeGetterFunctions.put("companyId", Parent::getCompanyId);
			attributeGetterFunctions.put("name", Parent::getName);
			attributeGetterFunctions.put(
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"mvccVersion",
				(BiConsumer<Parent, Long>)Parent::setMvccVersion);
			attributeSetterBiConsumers.put(
				"ctCollectionId",
				(BiConsumer<Parent, Long>)Parent::setCtCollectionId);
			attributeSetterBiConsumers.put(
				"parentId", (BiConsumer<Parent, Long>)Parent::setParentId);
			attributeSetterBiConsumers.put(
				"companyId", (BiConsumer<Parent, Long>)Parent::setCompanyId);
			attributeSetterBiConsumers.put(
				"name", (BiConsumer<Parent, String>)Parent::setName);
			attributeSetterBiConsumers.put(
				"grandParentId",
				(BiConsumer<Parent, Long>)Parent::setGrandParentId);
	...
	public Object clone() {
		...
		parentImpl.setMvccVersion(getMvccVersion());
		parentImpl.setCtCollectionId(getCtCollectionId());
		parentImpl.setParentId(getParentId());
		parentImpl.setCompanyId(getCompanyId());
		parentImpl.setName(getName());
		parentImpl.setGrandParentId(getGrandParentId());
	...
	public Parent cloneWithOriginalValues() {
		...
		parentImpl.setMvccVersion(
			this.<Long>getColumnOriginalValue("mvccVersion"));
		parentImpl.setCtCollectionId(
		...
		parentImpl.setName(this.<String>getColumnOriginalValue("name"));
		parentImpl.setGrandParentId(
			this.<Long>getColumnOriginalValue("grandParentId"));
	...
	public CacheModel<Parent> toCacheModel() {
		...
		parentCacheModel.mvccVersion = getMvccVersion();

		parentCacheModel.ctCollectionId = getCtCollectionId();

		parentCacheModel.parentId = getParentId();

		parentCacheModel.companyId = getCompanyId();

		parentCacheModel.name = getName();

		String name = parentCacheModel.name;

		if ((name != null) && (name.length() == 0)) {
			parentCacheModel.name = null;
		}

		parentCacheModel.grandParentId = getGrandParentId();
	...
	public <T> T getColumnValue(String columnName) {
		Function<Parent, Object> function =
	...
	static {
		...
		columnBitmasks.put("parentId", 4L);
