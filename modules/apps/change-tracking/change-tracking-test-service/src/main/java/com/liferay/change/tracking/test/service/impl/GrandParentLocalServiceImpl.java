...
import com.liferay.change.tracking.test.service.base.GrandParentLocalServiceBaseImpl;
 ...
 */
@Component(
	property = "model.class.name=com.liferay.change.tracking.test.model.GrandParent",
