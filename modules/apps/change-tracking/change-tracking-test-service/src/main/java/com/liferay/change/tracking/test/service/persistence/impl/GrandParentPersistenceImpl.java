...
import com.liferay.change.tracking.test.exception.NoSuchGrandParentException;
...
import com.liferay.change.tracking.test.service.persistence.GrandParentPersistence;
import com.liferay.change.tracking.test.service.persistence.GrandParentUtil;
import com.liferay.change.tracking.test.service.persistence.impl.constants.CTTPersistenceConstants;
...
public class GrandParentPersistenceImpl
	...
	@Override
	@Reference(
		target = CTTPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = CTTPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
