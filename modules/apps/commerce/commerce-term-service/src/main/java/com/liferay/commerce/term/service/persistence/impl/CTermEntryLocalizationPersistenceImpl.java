...
public class CTermEntryLocalizationPersistenceImpl
	...
	public int countByCommerceTermEntryId(long commerceTermEntryId) {
		...
		finderPath = _finderPathCountByCommerceTermEntryId;
		...
		if (productionMode) {
			...
			finderArgs = new Object[] {
				CTCollectionThreadLocal.getCTCollectionId(), commerceTermEntryId
			};
		}
	...
	public int countByCommerceTermEntryId_LanguageId(
		...
		finderPath = _finderPathCountByCommerceTermEntryId_LanguageId;
