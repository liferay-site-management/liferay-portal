...
public class CommerceSubscriptionEntryPersistenceImpl
	...
	public int countByCommerceOrderItemId(long commerceOrderItemId) {
		...
		finderPath = _finderPathCountByCommerceOrderItemId;
		...
		if (productionMode) {
			...
			finderArgs = new Object[] {
				CTCollectionThreadLocal.getCTCollectionId(), commerceOrderItemId
			};
		}
	...
	public int countBySubscriptionStatus(int subscriptionStatus) {
		...
		finderPath = _finderPathCountBySubscriptionStatus;
		...
		if (productionMode) {
			...
			finderArgs = new Object[] {
				CTCollectionThreadLocal.getCTCollectionId(), subscriptionStatus
			};
		}
