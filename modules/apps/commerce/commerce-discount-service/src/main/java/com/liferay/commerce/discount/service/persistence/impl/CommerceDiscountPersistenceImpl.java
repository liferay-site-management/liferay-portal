...
public class CommerceDiscountPersistenceImpl
	...
	public List<CommerceDiscount> findByC_C(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (productionMode) {
				...
				finderArgs = new Object[] {
					CTCollectionThreadLocal.getCTCollectionId(), companyId,
					couponCode, start, end, orderByComparator
				};
			}
		}
	...
	public List<CommerceDiscount> findByC_L_A_S(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (productionMode) {
				...
				finderArgs = new Object[] {
					CTCollectionThreadLocal.getCTCollectionId(), companyId,
					level, active, status, start, end, orderByComparator
				};
			}
		}
	...
	public int countByC_L_A_S(
		...
		finderPath = _finderPathCountByC_L_A_S;
		...
		if (productionMode) {
			...
			finderArgs = new Object[] {
				CTCollectionThreadLocal.getCTCollectionId(), companyId, level,
				active, status
			};
		}
