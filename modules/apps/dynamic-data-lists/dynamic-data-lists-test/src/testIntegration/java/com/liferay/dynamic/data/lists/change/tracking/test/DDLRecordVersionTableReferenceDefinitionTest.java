...
public class DDLRecordVersionTableReferenceDefinitionTest
	...
	public void setUp() throws Exception {
		...
		_ddlRecord = _ddlRecordLocalService.addRecord(
			TestPropsValues.getUserId(), group.getGroupId(),
	...
	protected CTModel<?> addCTModel() throws Exception {
		DDLRecordVersion ddlRecordVersion = _ddlRecord.getRecordVersion();

		return _ddlRecordVersionLocalService.addDDLRecordVersion(
			_ddlRecordVersionLocalService.createDDLRecordVersion(
