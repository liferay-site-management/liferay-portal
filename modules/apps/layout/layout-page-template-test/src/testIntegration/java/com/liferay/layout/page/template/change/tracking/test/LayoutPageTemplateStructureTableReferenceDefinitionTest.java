...
public class LayoutPageTemplateStructureTableReferenceDefinitionTest
	...
	public void setUp() throws Exception {
		...
		_layoutPageTemplateStructure =
			_layoutPageTemplateStructureLocalService.
				createLayoutPageTemplateStructure(RandomTestUtil.randomLong());
	}

	@Override
	protected CTModel<?> addCTModel() throws Exception {
		return _layoutPageTemplateStructureLocalService.
			addLayoutPageTemplateStructure(_layoutPageTemplateStructure);
	}
