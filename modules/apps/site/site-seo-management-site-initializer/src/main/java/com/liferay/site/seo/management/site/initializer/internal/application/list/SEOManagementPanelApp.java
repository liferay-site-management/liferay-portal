...
package com.liferay.site.seo.management.site.initializer.internal.application.list;
...
@Component(
	property = {
		...
		"panel.category.key=applications_menu.applications.seo_management"
	},
	service = PanelApp.class
)
public class SEOManagementPanelApp extends BasePanelApp {
	...
	public String getLabel(Locale locale) {
		return _language.get(locale, "seo-management");
	}
	...
	public String getPortletId() {
		return "applications_menu.applications.seo_management";
	}
		...
		return new PortletURLWrapper(null) {
			...
			public String toString() {
				return themeDisplay.getPathFriendlyURLPublic() +
					SEOManagementConstants.SEO_MANAGEMENT_FRIENDLY_URL;
			}
	...
	public boolean isShow(PermissionChecker permissionChecker, Group group)
		...
		Group seoGroup = _groupLocalService.fetchGroup(
			group.getCompanyId(), GroupConstants.SEO_MANAGEMENT);
