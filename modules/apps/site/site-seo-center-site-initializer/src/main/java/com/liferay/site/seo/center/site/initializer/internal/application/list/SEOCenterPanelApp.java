...
package com.liferay.site.seo.center.site.initializer.internal.application.list;
...
@Component(
	property = {
		...
		"panel.category.key=applications_menu.applications.seo_center"
	},
	service = PanelApp.class
)
public class SEOCenterPanelApp extends BasePanelApp {
	...
	public String getLabel(Locale locale) {
		return _language.get(locale, "seo-center");
	}
	...
	public String getPortletId() {
		return "applications_menu.applications.seo_center";
	}
		...
		return new PortletURLWrapper(null) {
			...
			public String toString() {
				return themeDisplay.getPathFriendlyURLPublic() +
					SEOCenterConstants.SEO_CENTER_FRIENDLY_URL;
			}
	...
	public boolean isShow(PermissionChecker permissionChecker, Group group)
		...
		Group seoGroup = _groupLocalService.fetchGroup(
			group.getCompanyId(), GroupConstants.SEO_CENTER);
