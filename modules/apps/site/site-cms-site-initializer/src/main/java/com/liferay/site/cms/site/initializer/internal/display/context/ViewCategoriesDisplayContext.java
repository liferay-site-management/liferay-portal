...
public class ViewCategoriesDisplayContext {
	...
	public Map<String, Object> getBreadcrumbReactData() throws Exception {
		...
		jsonArray.put(
			JSONUtil.put(
				...
				"label", _language.get(_httpServletRequest, "categorization")
			)
		).put(
			JSONUtil.put(
				"active", true
	...
	public List<FDSActionDropdownItem> getFDSActionDropdownItems()
		...
		FDSActionDropdownItem edit = new FDSActionDropdownItem(
			HttpComponentsUtil.addParameters(
				_portal.getLayoutFullURL(
					...
					_themeDisplay),
				"categoryId", "{id}", "vocabularyId", "{taxonomyVocabularyId}"),
			"pencil", "edit", _language.get(_httpServletRequest, "edit"), "get",
			"update", null);

		FDSActionDropdownItem addSubcategory = new FDSActionDropdownItem(
			"TODO: Add Subcategory URL", null, "add-subcategory",
			_language.get(_httpServletRequest, "add-subcategory"), "get",
			"update", null);

		FDSActionDropdownItem move = new FDSActionDropdownItem(
			"TODO: Move URL", null, "move",
			_language.get(_httpServletRequest, "move"), null, "update", null);

		FDSActionDropdownItem permissions = new FDSActionDropdownItem(
			_getEditPermissionsUrl(), "password-policies", "permissions",
			_language.get(_httpServletRequest, "permissions"), "get",
			"permissions", "modal-permissions");

		FDSActionDropdownItem delete = new FDSActionDropdownItem(
			null, "times-circle", "delete",
			_language.get(_httpServletRequest, "delete"), "delete", "delete",
			"headless");

		return ListUtil.fromArray(
			edit, addSubcategory, move, permissions, delete);
	}
