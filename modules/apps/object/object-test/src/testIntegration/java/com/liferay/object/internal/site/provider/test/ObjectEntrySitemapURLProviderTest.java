...
public class ObjectEntrySitemapURLProviderTest {
	...
	public void testVisitLayout() throws Exception {
		...
		_updateObjectDefinitionActive(false);
		...
		try {
			...
			_updateObjectDefinitionActive(true);
		}

		// Layout excluded from the sitemap

		_updateCanonicalURLEnabled(true, layout);
		...
		try {
			...
			_updateCanonicalURLEnabled(false, layout);
		}
	}
	...
	private void _updateCanonicalURLEnabled(
	...
	private void _updateObjectDefinitionActive(boolean active)
		throws Exception {
