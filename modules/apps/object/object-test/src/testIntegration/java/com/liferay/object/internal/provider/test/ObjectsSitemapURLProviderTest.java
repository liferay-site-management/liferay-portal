...
package com.liferay.object.internal.provider.test;
...
public class ObjectsSitemapURLProviderTest {
	...
	public void testObjectsSitemapURLProviderDefaultDisplayPageCanonicalURLEnabled()
		...
		_objectsSitemapURLProvider.visitLayout(
	...
	private void _assertRootElement(
			...
			Layout layout, Element rootElement, String urlSeparator)
		throws Exception {
	...
	@Inject(
		filter = "component.name=com.liferay.object.internal.provider.ObjectsSitemapURLProvider",
		type = SitemapURLProvider.class
	)
	private SitemapURLProvider _objectsSitemapURLProvider;
