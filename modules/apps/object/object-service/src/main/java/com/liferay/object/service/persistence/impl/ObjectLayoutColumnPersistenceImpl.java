...
public class ObjectLayoutColumnPersistenceImpl
	...
	public List<ObjectLayoutColumn> findByObjectFieldId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (productionMode) {
				...
				finderArgs = new Object[] {
					CTCollectionThreadLocal.getCTCollectionId(), objectFieldId,
	...
	public int countByObjectFieldId(long objectFieldId) {
		...
		finderPath = _finderPathCountByObjectFieldId;
	...
	public int countByObjectLayoutRowId(long objectLayoutRowId) {
		...
		finderPath = _finderPathCountByObjectLayoutRowId;
		...
		if (productionMode) {
			...
			finderArgs = new Object[] {
				CTCollectionThreadLocal.getCTCollectionId(), objectLayoutRowId
			};
		}
