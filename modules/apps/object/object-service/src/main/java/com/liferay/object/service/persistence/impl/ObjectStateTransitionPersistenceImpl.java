...
public class ObjectStateTransitionPersistenceImpl
	...
	public int countByObjectStateFlowId(long objectStateFlowId) {
		...
		finderPath = _finderPathCountByObjectStateFlowId;
		...
		if (productionMode) {
			...
			finderArgs = new Object[] {
				CTCollectionThreadLocal.getCTCollectionId(), objectStateFlowId
			};
		}
	...
	public int countBySourceObjectStateId(long sourceObjectStateId) {
		...
		finderPath = _finderPathCountBySourceObjectStateId;
		...
		if (productionMode) {
			...
			finderArgs = new Object[] {
				CTCollectionThreadLocal.getCTCollectionId(), sourceObjectStateId
			};
		}
	...
	public int countByTargetObjectStateId(long targetObjectStateId) {
		...
		finderPath = _finderPathCountByTargetObjectStateId;
		...
		if (productionMode) {
			...
			finderArgs = new Object[] {
				CTCollectionThreadLocal.getCTCollectionId(), targetObjectStateId
			};
		}
