...
public class ObjectActionPersistenceImpl
	...
	public List<ObjectAction> findByO_A_OATK(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (productionMode) {
				finderArgs = new Object[] {
					objectDefinitionId, active, objectActionTriggerKey, start,
					end, orderByComparator
				};
			}
			else {
	...
	public int countByO_A_OATK(
		...
		finderPath = _finderPathCountByO_A_OATK;
	...
	public int countByODI_A_N_OATK(
		...
		finderPath = _finderPathCountByODI_A_N_OATK;
