...
public class ObjectDefinitionPersistenceImpl
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				if (productionMode) {
					...
					finderArgs = new Object[] {
						CTCollectionThreadLocal.getCTCollectionId(), system
					};
				}
			}
		}
			...
			if (productionMode) {
				...
				finderArgs = new Object[] {
					CTCollectionThreadLocal.getCTCollectionId(), system, start,
					end, orderByComparator
				};
			}
		}
	...
	public int countBySystem(boolean system) {
		...
		finderPath = _finderPathCountBySystem;
	...
	public List<ObjectDefinition> findByS_S(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (productionMode) {
				...
				finderArgs = new Object[] {
					CTCollectionThreadLocal.getCTCollectionId(), system, status,
					start, end, orderByComparator
				};
			}
		}
	...
	public List<ObjectDefinition> findByC_A_S(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (productionMode) {
				...
				finderArgs = new Object[] {
					CTCollectionThreadLocal.getCTCollectionId(), companyId,
					active, status, start, end, orderByComparator
				};
			}
		}
	...
	public List<ObjectDefinition> findByC_A_M_S(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (productionMode) {
				...
				finderArgs = new Object[] {
					CTCollectionThreadLocal.getCTCollectionId(), companyId,
					active, modifiable, status, start, end, orderByComparator
				};
			}
		}
	...
	public int countByC_A_M_S(
		...
		finderPath = _finderPathCountByC_A_M_S;

		if (productionMode) {
			finderArgs = new Object[] {companyId, active, modifiable, status};
		}
		else {
			finderArgs = new Object[] {
				CTCollectionThreadLocal.getCTCollectionId(), companyId, active,
	...
	public List<ObjectDefinition> findByC_A_S_S(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (productionMode) {
				...
				finderArgs = new Object[] {
					CTCollectionThreadLocal.getCTCollectionId(), companyId,
					active, system, status, start, end, orderByComparator
				};
			}
		}
	...
	public int countByC_A_S_S(
		...
		finderPath = _finderPathCountByC_A_S_S;
