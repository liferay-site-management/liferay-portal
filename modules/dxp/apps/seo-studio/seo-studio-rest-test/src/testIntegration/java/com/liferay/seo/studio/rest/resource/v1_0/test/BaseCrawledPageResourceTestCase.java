...
public abstract class BaseCrawledPageResourceTestCase {
	...
	public void testGetCrawlHitsPage() throws Exception {
		Long seoStudioDomainId = testGetCrawlHitsPage_getSeoStudioDomainId();
		Long irrelevantSeoStudioDomainId =
			testGetCrawlHitsPage_getIrrelevantSeoStudioDomainId();

		Page<CrawledPage> page = crawledPageResource.getCrawlHitsPage(
		...
		if (irrelevantSeoStudioDomainId != null) {
			CrawledPage irrelevantCrawledPage =
				testGetCrawlHitsPage_addCrawledPage(
					irrelevantSeoStudioDomainId, randomIrrelevantCrawledPage());

			page = crawledPageResource.getCrawlHitsPage(
			...
			assertValid(
				page,
				testGetCrawlHitsPage_getExpectedActions(
					irrelevantSeoStudioDomainId));
		}

		CrawledPage crawledPage1 = testGetCrawlHitsPage_addCrawledPage(
			seoStudioDomainId, randomCrawledPage());

		CrawledPage crawledPage2 = testGetCrawlHitsPage_addCrawledPage(
			seoStudioDomainId, randomCrawledPage());
		...
		assertValid(
			page, testGetCrawlHitsPage_getExpectedActions(seoStudioDomainId));
	}

	protected Map<String, Map<String, String>>
			testGetCrawlHitsPage_getExpectedActions(Long seoStudioDomainId)
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-931570808