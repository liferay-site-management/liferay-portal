...
public interface AIRequestResource {
	...
	public static class Builder {
		...
		public AIRequestResource build() {
			return new AIRequestResourceImpl(this);
		}
	...
	public static class AIRequestResourceImpl implements AIRequestResource {
		...
		public Page<AIRequest> getAIRequestsPage(Pagination pagination)
			...
			HttpInvoker.HttpResponse httpResponse =
				getAIRequestsPageHttpResponse(pagination);
			...
			try {
				return Page.of(content, AIRequestSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private AIRequestResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			AIRequestResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:-1990997134