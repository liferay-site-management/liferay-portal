 ...
 */
@Generated("")
@GraphQLName("AIRequest")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "AIRequest")
public class AIRequest implements Serializable {

	public static AIRequest toDTO(String json) {
		return ObjectMapperUtil.readValue(AIRequest.class, json);
	}

	public static AIRequest unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(AIRequest.class, json);
	}
	...
	public Date getRequestDate() {
		if (_requestDateSupplier != null) {
			requestDate = _requestDateSupplier.get();

			_requestDateSupplier = null;
		}
	...
	public void setRequestDate(
		...
		_requestDateSupplier = () -> {
			try {
				return requestDateUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<Date> _requestDateSupplier;
	...
	public String toString() {
		...
		if (requestDate != null) {
			...
			sb.append(liferayToJSONDateFormat.format(requestDate));
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.seo.studio.rest.dto.v1_0.AIRequest",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:908980427