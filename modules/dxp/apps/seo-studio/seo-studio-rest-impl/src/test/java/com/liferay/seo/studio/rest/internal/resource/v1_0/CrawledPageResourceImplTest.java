...
public class CrawledPageResourceImplTest {
	...
	@Test
	public void testGetCrawlHitsPageFiltersLanguagePrefixedURLs()
		throws Exception {

		_mockObjectEntry(_TEST_COMPANY_ID, "liferay.com");
		_setUpSearchResponse(
			_hit("https://liferay.com/en/web/foo", "EN", null),
			_hit("https://liferay.com/en-us/web/foo", "EN-US", null),
			_hit("https://liferay.com/pt-br/group/foo", "PT-BR", null),
			_hit("https://liferay.com/fr/web/foo", "FR", null),
			_hit("https://liferay.com/o/api", "API", null));
		...
		Assert.assertEquals("https://liferay.com/o/api", crawledPage.getUrl());
	}

	@Test
	public void testGetCrawlHitsPageLanguagePrefixIsCaseSensitive()
		throws Exception {

		_mockObjectEntry(_TEST_COMPANY_ID, "liferay.com");
		_setUpSearchResponse(
			_hit("https://liferay.com/EN/web/foo", "Uppercase EN", null));
	...
	@Test
	public void testGetCrawlHitsPageResolvesIndexNameForMixedCaseHostname()
		throws Exception {
		...
		Assert.assertEquals(
			"seo_studio_liferay.com", _captureSearchedIndexName());
	}

	@Test
	public void testGetCrawlHitsPageResolvesIndexNameForSchemePrefixedHostname()
		throws Exception {

		_mockObjectEntry(_TEST_COMPANY_ID, "https://liferay.com/");
		_setUpSearchResponse();
	...
	public void testGetCrawlHitsPageThrowsWhenCrossCompany() throws Exception {
		_mockObjectEntry(_TEST_COMPANY_ID + 1, "liferay.com");

		_crawledPageResourceImpl.getCrawlHitsPage(_DOMAIN_ID, null);
	}

	@Test(expected = NoSuchObjectEntryException.class)
	public void testGetCrawlHitsPageThrowsWhenHostnameNull() throws Exception {
		_mockObjectEntry(_TEST_COMPANY_ID, null);

		_crawledPageResourceImpl.getCrawlHitsPage(_DOMAIN_ID, null);
	}

	@Test(expected = NoSuchObjectEntryException.class)
	public void testGetCrawlHitsPageThrowsWhenObjectEntryMissing()
		throws Exception {
