...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {crawlHits(indexName: ___, maxDocs: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(
		description = "Returns crawl hits from the Elasticsearch index for a given hostname."
	)
	public CrawledPagePage crawlHits(
		...
		return _applyComponentServiceObjects(
			...
			crawledPageResource -> new CrawledPagePage(
				crawledPageResource.getCrawlHitsPage(indexName, maxDocs)));
	}
...
// LIFERAY-REST-BUILDER-HASH:1300014601