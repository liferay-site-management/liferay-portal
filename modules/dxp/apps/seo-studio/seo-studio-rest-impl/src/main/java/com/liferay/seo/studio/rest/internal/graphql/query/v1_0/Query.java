...
public class Query {
	 ...
	 */
	@GraphQLField(
		description = "Returns crawl hits for the SEO Studio Domain identified by seoStudioDomainId. The index is resolved server-side, so callers cannot address indexes belonging to Domains they do not own."
	)
...
// LIFERAY-REST-BUILDER-HASH:-1990430302