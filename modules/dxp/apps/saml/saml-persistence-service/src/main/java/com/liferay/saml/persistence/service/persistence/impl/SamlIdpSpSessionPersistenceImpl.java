...
public class SamlIdpSpSessionPersistenceImpl
	...
	public int countByLtCreateDate(Date createDate) {
		...
		finderPath = _finderPathWithPaginationCountByLtCreateDate;
	...
	public int countBySamlIdpSsoSessionId(long samlIdpSsoSessionId) {
		...
		finderPath = _finderPathCountBySamlIdpSsoSessionId;
		...
		if (productionMode) {
			...
			finderArgs = new Object[] {
				CTCollectionThreadLocal.getCTCollectionId(), samlIdpSsoSessionId
			};
		}
