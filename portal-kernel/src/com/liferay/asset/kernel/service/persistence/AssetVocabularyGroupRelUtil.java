...
public class AssetVocabularyGroupRelUtil {
	 ...
	 * @throws NoSuchVocabularyGroupRelException if a matching asset vocabulary group rel could not be found
	 */
	public static AssetVocabularyGroupRel findByV_G(
			long vocabularyId, long groupId)
		throws com.liferay.asset.kernel.exception.
			NoSuchVocabularyGroupRelException {

		return getPersistence().findByV_G(vocabularyId, groupId);
	}
	 ...
	 * @return the matching asset vocabulary group rel, or <code>null</code> if a matching asset vocabulary group rel could not be found
	 */
	public static AssetVocabularyGroupRel fetchByV_G(
		long vocabularyId, long groupId) {

		return getPersistence().fetchByV_G(vocabularyId, groupId);
	}
	...
	public static AssetVocabularyGroupRel fetchByV_G(
		...
		return getPersistence().fetchByV_G(
			vocabularyId, groupId, useFinderCache);
	}
	 ...
	 * @return the asset vocabulary group rel that was removed
	 */
	public static AssetVocabularyGroupRel removeByV_G(
			long vocabularyId, long groupId)
		throws com.liferay.asset.kernel.exception.
			NoSuchVocabularyGroupRelException {

		return getPersistence().removeByV_G(vocabularyId, groupId);
	}
	 ...
	 * @return the number of matching asset vocabulary group rels
	 */
	public static int countByV_G(long vocabularyId, long groupId) {
		return getPersistence().countByV_G(vocabularyId, groupId);
	}
